...
class _UserManagementScreenState extends State<UserManagementScreen> {
  ...
  Future<void> _loadUsers() async {
    final allUsers = await AuthService().getUsers().first; // lấy danh sách hiện tại
    setState(() {
      users = allUsers;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ElevatedButton.icon(
            ...
            actions: [
              ...
              TextButton(
                ...
                child: Text(isLocked ? "Mở Khóa" : "Khóa",
                    style: TextStyle(color: isLocked ? theme.colorScheme.primary : theme.colorScheme.error)),
              ),
            ],
          ),
        );
      ...
      style: ElevatedButton.styleFrom(
        backgroundColor: isLocked ? theme.colorScheme.primary : theme.colorScheme.error,
