...
class CommentSection extends StatefulWidget {
  final String foodId;
  final int pageSize;
  /// If false, the widget will hide the comments list and only render the input box.
  /// Use this when you want to always show the input field but optionally collapse the list preview.
  final bool showList;
...
class _CommentSectionState extends State<CommentSection> {
  ...
  Widget _buildCommentItemFromMap(Map<String, dynamic> doc) {
    ...
    return CommentItem(
      comment: doc,
      currentUserId: uid,
      onDelete: () => _deleteComment(id, authorId),
    );
  }
